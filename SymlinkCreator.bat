...
set ICU_LIB_DIR=%SOURCE_DIR%\ICU\lib\Win32\
set LICENSE_DIR=%SOURCE_DIR%\licensecc\projects\


cd %SERVER_DIR%
call :MKLINK_DIFFNAME "GateServer_x86_Release.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "AccountServer_x86_Release.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "GameServer_x86_Release.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "GroupServer_x86_Release.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"

call :MKLINK_DIFFNAME "GateServer_x86_Debug.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "AccountServer_x86_Debug.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "GameServer_x86_Debug.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"
call :MKLINK_DIFFNAME "GroupServer_x86_Debug.lic" "%LICENSE_DIR%\Yatops Server\licenses\ServerPermanentLicense.lic"

cd %TRANSLATION_DIR%
call :MKLINK "%ICU_LIB_DIR%\Release\derb.exe"
call :MKLINK "%ICU_LIB_DIR%\Release\genrb.exe"
call :MKLINK "%ICU_LIB_DIR%\Release\icuuc70.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icuin70.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icutu70.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icudt70.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icuio70.dll"
:: Compile resource files before creating symlink based on them
call compile.bat

cd %CLIENT_SYSTEM_DIR%
call :MKLINK "%SOURCE_DIR%\LuaJIT\lib\x86\lua51.dll"
call :MKLINK "%ICU_LIB_DIR%\Debug\icudt70.dll"
call :MKLINK "%ICU_LIB_DIR%\Debug\icuin70d.dll"
call :MKLINK "%ICU_LIB_DIR%\Debug\icuuc70d.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icuin70.dll"
call :MKLINK "%ICU_LIB_DIR%\Release\icuuc70.dll"
...
cd %SERVER_DIR%\
call :MKLINK "%SOURCE_DIR%\LuaJIT\lib\x86\lua51.dll"
call :MKLINK "%SOURCE_DIR%\ICU\lib\Win32\Debug\icudt70.dll"
call :MKLINK "%SOURCE_DIR%\ICU\lib\Win32\Debug\icuin70d.dll"
call :MKLINK "%SOURCE_DIR%\ICU\lib\Win32\Debug\icuuc70d.dll"
call :MKLINK "%SOURCE_DIR%\ICU\lib\Win32\Release\icuin70.dll"
call :MKLINK "%SOURCE_DIR%\ICU\lib\Win32\Release\icuuc70.dll"
