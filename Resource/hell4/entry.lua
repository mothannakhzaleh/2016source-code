...
function after_create_entry(entry) 
    ...
    HELL4_ENTRY_LUA_000001 = GetResString("HELL4_ENTRY_LUA_000001")
    HELL4_ENTRY_LUA_000002 = GetResString("HELL4_ENTRY_LUA_000002")
    Notice(HELL4_ENTRY_LUA_000002..posx..","..posy..HELL4_ENTRY_LUA_000001) --通知本组服务器的所有玩家
...
function begin_enter_hell4(role, copy_mgr) 
		...
		MoveCity(role, HELL4_ENTRY_LUA_000003)
