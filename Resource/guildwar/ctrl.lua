...
function map_copy_run_guildwar( map_copy )
    ...
    local closetime = GUILDWARCLOSETIME
		 ...
		 if closetime == GUILDCLOSESHOW[i] then
			 GUILDWAR_CTRL_LUA_000004 = GetResString("GUILDWAR_CTRL_LUA_000004")
			 GUILDWAR_CTRL_LUA_000005 = GetResString("GUILDWAR_CTRL_LUA_000005")
			 local Notice_all = GUILDWAR_CTRL_LUA_000005..closetime..GUILDWAR_CTRL_LUA_000004
...
--		local GuildName_Blue = GetGuildName ( BlueSide_GuildID )
		...
		if CheckMonsterDead ( haijunSide_BaseRole ) == 1 then
		   if haidaoSide_JDNotice == 0 then
			...
			five_seconds = 1
			--local Notice_all = "圣战战场的海盗阵营获得了胜利！"
			--Notice ( Notice_all )
			...
			GUILDWAR_CTRL_LUA_000008 = GetResString("GUILDWAR_CTRL_LUA_000008")
			local Notice_all = GUILDWAR_CTRL_LUA_000008
			Notice ( Notice_all )
		...
		if CheckMonsterDead ( haidaoSide_BaseRole ) == 1 then
			...
			--local Notice_all =  "圣战战场的海军阵营获得了胜利！"
			--Notice ( Notice_all )
			SZ_Win_CountNum = SZ_Win_CountNum - 1
			--PK_JJHY_Winner = "海盗阵营"
			--PK_JJHY_Loser = "海军阵营"
			...
			--DealAllActivePlayerInMap(map_copy,"noside_Goto")
			DealAllActivePlayerInMap(map_copy,"Give_Three_QiYue")
			GUILDWAR_CTRL_LUA_000009 = GetResString("GUILDWAR_CTRL_LUA_000009")
			local Notice_all =  GUILDWAR_CTRL_LUA_000009
			Notice ( Notice_all )
		...
		if Count == math.floor ( Count ) then
			...
			GUILDWAR_CTRL_LUA_000014 = GetResString("GUILDWAR_CTRL_LUA_000014")
			GUILDWAR_CTRL_LUA_000015 = GetResString("GUILDWAR_CTRL_LUA_000015")
			local Notice_map = GUILDWAR_CTRL_LUA_000015..SZ_Win_CountNum..GUILDWAR_CTRL_LUA_000014
		...
		GUILDWAR_CTRL_LUA_000016 = GetResString("GUILDWAR_CTRL_LUA_000016")
		MapCopyNotice ( map_copy ,GUILDWAR_CTRL_LUA_000016)
...
--end
   ...
   GUILDWAR_CTRL_LUA_000017 = GetResString("GUILDWAR_CTRL_LUA_000017")
   Notice(GUILDWAR_CTRL_LUA_000017)
   end
   if second_five_seconds == 120 then
   GUILDWAR_CTRL_LUA_000018 = GetResString("GUILDWAR_CTRL_LUA_000018")
   Notice(GUILDWAR_CTRL_LUA_000018)
   end
   if second_five_seconds == 144 then
   GUILDWAR_CTRL_LUA_000019 = GetResString("GUILDWAR_CTRL_LUA_000019")
   Notice(GUILDWAR_CTRL_LUA_000019)
   end
   if second_five_seconds == 168 then
   GUILDWAR_CTRL_LUA_000020 = GetResString("GUILDWAR_CTRL_LUA_000020")
   Notice(GUILDWAR_CTRL_LUA_000020)
   end
...
GUILDWAR_CTRL_LUA_000021 = GetResString("GUILDWAR_CTRL_LUA_000021")
KillMonsterInMapByName(map_copy,GUILDWAR_CTRL_LUA_000021)
GUILDWAR_CTRL_LUA_000022 = GetResString("GUILDWAR_CTRL_LUA_000022")
KillMonsterInMapByName(map_copy,GUILDWAR_CTRL_LUA_000022)
--ClearAllSubMapMonster(map_copy)
ClearAllSubMapCha(map_copy)
