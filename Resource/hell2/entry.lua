...
function after_create_entry(entry) 
    ...
    HELL2_ENTRY_LUA_000001 = GetResString("HELL2_ENTRY_LUA_000001")
    local EntryName = HELL2_ENTRY_LUA_000001
    SetMapEntryEventName( entry, EntryName )
    
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --取地图入口的位置信息（地图名，坐标，目标地图名）
    HELL2_ENTRY_LUA_000002 = GetResString("HELL2_ENTRY_LUA_000002")
    HELL2_ENTRY_LUA_000003 = GetResString("HELL2_ENTRY_LUA_000003")
    Notice(HELL2_ENTRY_LUA_000003..posx..","..posy..HELL2_ENTRY_LUA_000002) --通知本组服务器的所有玩家
...
function begin_enter_hell2(role, copy_mgr) 
		...
		MoveCity(role, HELL2_ENTRY_LUA_000005)
