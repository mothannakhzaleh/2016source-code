...
function after_create_entry(entry) 
    ...
    MJING3_ENTRY_LUA_000001 = GetResString("MJING3_ENTRY_LUA_000001")
    Notice(MJING3_ENTRY_LUA_000001) --通知本组服务器的所有玩家
...
function after_player_login_mjing3(entry, player_name)
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --取地图入口的位置信息（地图名，坐标，目标地图名）
    MJING3_ENTRY_LUA_000003 = GetResString("MJING3_ENTRY_LUA_000003")
    ChaNotice(player_name, MJING3_ENTRY_LUA_000003) --通知本组服务器的所有玩家
