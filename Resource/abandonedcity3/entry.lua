...
function begin_enter_abandonedcity3(role, copy_mgr) 
    ABANDONEDCITY3_ENTRY_LUA_000001 = GetResString("ABANDONEDCITY3_ENTRY_LUA_000001")
    SystemNotice(role,ABANDONEDCITY3_ENTRY_LUA_000001) 
    ABANDONEDCITY3_ENTRY_LUA_000002 = GetResString("ABANDONEDCITY3_ENTRY_LUA_000002")
    MoveCity(role, ABANDONEDCITY3_ENTRY_LUA_000002)
