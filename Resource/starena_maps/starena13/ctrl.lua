...
function get_map_entry_pos_starena13()   --设置入口的位置的坐标（坐标（米））
	local POS_X=0
	local POS_Y=0
	return POS_X , POS_Y
end
...
function map_copy_first_run_starena13( map_copy )
	
end

function map_copy_run_starena13( map_copy )
end
...
function can_open_entry_starena13( map ) 
end 
