...
function map_copy_run_special_garner2( map_copy ) 
	...
	GARNER2_CTRL_LUA_000001 = GetResString("GARNER2_CTRL_LUA_000001")
	GARNER2_CTRL_LUA_000002 = GetResString("GARNER2_CTRL_LUA_000002")
	Notice(GARNER2_CTRL_LUA_000002..HowManyNoDead..GARNER2_CTRL_LUA_000001)
...
--	SystemNotice(role,How_Many_Active)
	...
	--	local message = "今天的乱斗共存活了"..How_Many_Active .. "位玩家,他们每人将获得"..Money_Garner2 .."的金钱"
	--	SystemNotice(role,How_Many_Active)
		return
	end
	...
	if How_Many_Active <  6 and How_Many_Active > 1 then
		...
		--local message = "今天的乱斗中共存活了"..How_Many_Active .."位玩家,他们每人将获得"..Money_Garner2 .."的金钱和1个乱斗之星徽章"
		--Notice ( message )
		return
	end
	...
	if How_Many_Active == 1 then
		...
		GARNER2_CTRL_LUA_000003 = GetResString("GARNER2_CTRL_LUA_000003")
		GARNER2_CTRL_LUA_000004 = GetResString("GARNER2_CTRL_LUA_000004")
		GARNER2_CTRL_LUA_000005 = GetResString("GARNER2_CTRL_LUA_000005")
		local message = GARNER2_CTRL_LUA_000005..cha_name..GARNER2_CTRL_LUA_000004.. Money_Garner2 ..GARNER2_CTRL_LUA_000003
	--	SystemNotice(role,How_Many_Active)
