...
public:
	...
	void	KickUser(DataSocket *datasock,unsigned long long gpaddr, unsigned long long gtaddr);
...
//		TBLSystem	*	m_tblsystem;
		...
		friend_tbl*		m_tblX1{};
#ifdef SHUI_JING
		TBLCrystalTrade * m_tblcrystal;//Add by sunny.sun 20090603
#endif
		IniFile			m_cfg;
